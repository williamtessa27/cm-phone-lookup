...
describe('Métadonnées des pays', () => {
  ...
  describe('getAllCountries', () => {
    test('retourne tous les codes pays supportés', () => {
      ...
      expect(countries).toHaveLength(14); // 11 pays originaux + 3 nouveaux (RDC, Ouganda, Algérie)
    });
  ...
  describe('Spécificités linguistiques', () => {
    test('le Cameroun est le seul pays bilingue', () => {
      ...
      expect(bilingualCountries).toHaveLength(9); // Cameroun, Kenya, Afrique du Sud, Maroc, Éthiopie, Égypte, Tanzanie, Ouganda, Algérie
    ...
    test('distribution des langues', () => {
      ...
      expect(frenchCountries).toBe(6); // Cameroun, Sénégal, Côte d'Ivoire, Maroc, RDC, Algérie
      ...
      expect(englishCountries).toBe(9); // Cameroun, Nigeria, Ghana, Kenya, Afrique du Sud, Éthiopie, Égypte, Tanzanie, Ouganda
