...
console.log("Numéro invalide (mauvais format):", isValidNumber("+237123456789")); // false

// Tests d'information complète
console.log("\n📊 Tests d'information complète:");
console.log("Info MTN:", JSON.stringify(getPhoneInfo("+237650123456"), null, 2));
console.log("Info ORANGE:", JSON.stringify(getPhoneInfo("+237655123456"), null, 2));
console.log("Info CAMTEL:", JSON.stringify(getPhoneInfo("+23722212345"), null, 2));
...
console.log("Numéro avec caractères spéciaux:", detectOperator("+237-650-123-456")); // MTN
